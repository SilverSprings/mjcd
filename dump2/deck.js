...
function cardsShuffled() {
	...
	var cardsHeart   = values.map( (r) => {{value:r, suit:"h"}} ); 
	var cardsDiamond = values.map( (r) => {{value:r, suit:"d"}} ); 
	var cardsSpade   = values.map( (r) => {{value:r, suit:"s"}} ); 
	var cardsClub    = values.map( (r) => {{value:r, suit:"c"}} ); 
...
exports.module = newdeckshuffled;
