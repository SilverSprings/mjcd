...
export class ResultsComponent implements OnInit {
  ...
  */  
  ...
  ngOnInit() {
	...
	this.busted = this.checkBustedHand(this.allHands[0]);
	if (busted) {
		this.allHands[0].fhand.handValue = -1;
		this.allHands[0].mhand.handValue = -1;
		this.allHands[0].lhand.handValue = -1;		
	}
  ...
  checkBustedHand(currentHand) {
	...
	if (currentHand.lHand.handSubValue > currentHand.mHand.handSubValue) return true;
	return false;
  }
